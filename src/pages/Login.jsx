...
export default function Login() {
  ...
  const handleSubmit = e => {
    e.preventDefault();
    login({ nickname: form.nickname || '나', email: form.email });
    navigate('/');
  };
    ...
    <div style={{ maxWidth: 480, margin: '0 auto', padding: 0, background: '#f8f9fa', minHeight: '100vh' }}>
      ...
      <div style={{ padding: 32 }}>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <button type="submit" style={{ width: '100%', padding: 12, fontSize: 18, background: '#ff7e36', color: '#fff', border: 'none', borderRadius: 4, fontWeight: 600 }}>로그인</button>
        </form>
      </div>
    </div>
  );
